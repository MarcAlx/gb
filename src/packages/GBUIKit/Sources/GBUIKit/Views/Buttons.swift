...
class DPadScene: ButtonGroup {
    ...
    override func initNodes () {
        ...
        self.upButton = self.buildSymbolButton(CGPoint(x: 1.5*Double(buttonSize), y:  2.5 * Double(buttonSize)),buttonSize, "arrowtriangle.up", .UP, bgColor, fgColor, pressedColor)
        self.downButton = self.buildSymbolButton(CGPoint(x: 1.5*Double(buttonSize), y: 0.5 * Double(buttonSize)), buttonSize, "arrowtriangle.down", .DOWN,bgColor, fgColor, pressedColor)
        self.leftButton = self.buildSymbolButton(CGPoint(x: 0.5 * Double(buttonSize), y: 1.5*Double(buttonSize)),buttonSize, "arrowtriangle.left", .LEFT,bgColor, fgColor, pressedColor)
        self.rightButton = self.buildSymbolButton(CGPoint(x: 2.5 * Double(buttonSize), y: 1.5*Double(buttonSize)),buttonSize, "arrowtriangle.right", .RIGHT,bgColor, fgColor, pressedColor)
...
class ABStartSelectScene: ButtonGroup {
    ...
    override func initNodes () {
        ...
        self.aButton = self.buildRoundButton(CGPoint(x: 0.5 * Double(buttonSize), y: 1.5*Double(buttonSize)),buttonSize, "A", .A, abColor, abFGColor, abColorPressed)
        self.bButton = self.buildRoundButton(CGPoint(x: 1.5*Double(buttonSize)  , y:  2.5 * Double(buttonSize))   ,buttonSize, "B", .B,abColor, abFGColor, abColorPressed)
        self.selectButton = self.buildSmallButton(CGPoint(x: 1.5*Double(buttonSize), y: 0.5 * Double(buttonSize))   ,buttonSize, "select", .SELECT,startSelectColor, startSelectFGColor, startSelectColorPressed)
        self.startButton = self.buildSmallButton(CGPoint(x: 2.5 * Double(buttonSize), y: 1.5*Double(buttonSize))   ,buttonSize, "start", .START,startSelectColor, startSelectFGColor, startSelectColorPressed)
